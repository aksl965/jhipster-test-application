...
/**
 * REST controller for managing {@link io.github.jhipster.application.domain.Patient}.
 */
@RestController
@RequestMapping("/api")
public class PatientResource {
     ...
     */
    @GetMapping("/patients")
    public ResponseEntity<List<Patient>> getAllPatients(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
