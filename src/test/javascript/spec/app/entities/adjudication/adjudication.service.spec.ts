...
describe('Service Tests', () => {
  describe('Adjudication Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Adjudication(0, 0, 0, 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Adjudication', async () => {
      ...
      it('should update a Adjudication', async () => {
        const returnedFromService = Object.assign(
          {
            claimnumber: 1,
            casenumber: 1,
      ...
      it('should return a list of Adjudication', async () => {
        const returnedFromService = Object.assign(
          {
            claimnumber: 1,
            casenumber: 1,
      ...
      it('should delete a Adjudication', async () => {
